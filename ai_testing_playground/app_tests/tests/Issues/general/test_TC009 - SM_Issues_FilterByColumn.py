...
# First non-numeric column; "A" is a safe term for a text column.
COL_IDX = 0
FILTER_TERM = "A"


@pytest.mark.asyncio
async def test_TC009_SM_Issues_FilterByColumn(logged_in_page: Page):
    ...
    await page.verify_column_filter_results(COL_IDX, original, FILTER_TERM)
